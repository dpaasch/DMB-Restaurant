...
public class MenuService {
    ...
    /**
     * Returns the list of menu items retrieved from the mock database (MenuDatabase).
     * @return the value of the private variable identifying the allMenuItems object
     */
     ...
     * @return the value of the private variable identifying the orderedMenuItem object.
